# Outbox Pattern E Publica O De Eventos E78640

Aplicação backend `outbox-pattern-e-publica-o-de-eventos-e78640` construída com foco em boas práticas de engenharia.

## Visão Geral
- Nome da aplicação: `outbox-pattern-e-publica-o-de-eventos-e78640`
